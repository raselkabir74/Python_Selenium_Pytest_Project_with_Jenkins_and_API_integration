...
def test_regression_native_preview_page(login_by_user_type):
    ...
    native_creative_data['general_information'][
        'title'] = "Test Preview Native_" + generic_modules.get_random_string(5)
    ...
    campaign_data['landing_and_creatives'][
        'creative'] = native_creative_data['general_information']['title']
    campaign_data['name_and_type'][
        'creative_type'] = 'Native'
    campaign_data['name_and_type'][
        'campaign_name'] = 'Automation Preview Native'
    ...
    time.sleep(4)
    campaign_page.take_screenshot(
        'mobile_actual_view_screenshot_native.png')
    campaign_page.change_resolution(
        'mobile_actual_view_screenshot_native.png')
    ...
    try:
        ...
        for view_type in view_types:
            expected_screenshot_filename = f'{view_type}_view_screenshot_native.png'
            actual_screenshot_filename = f'{view_type}_actual_view_screenshot_native.png'
