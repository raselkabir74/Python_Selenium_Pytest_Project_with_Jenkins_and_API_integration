...
# Need to investigate why we get ValueError. (Locally we aren't getting this error)
# @pytest.mark.skip()
def test_regression_video_preview_page(login_by_user_type):
    ...
    vast_video_creative_data['general_information'][
        'title'] = "Test Preview Video_" + generic_modules.get_random_string(5)
    ...
    campaign_data['landing_and_creatives'][
        'creative'] = vast_video_creative_data['general_information']['title']
    campaign_data['name_and_type'][
        'campaign_name'] = 'Automation Preview Video'
    ...
    campaign_page.take_screenshot(
        'desktop_actual_view_screenshot_video.png')
    ...
    time.sleep(4)
    campaign_page.take_screenshot(
        'mobile_actual_view_screenshot_video.png')
    campaign_page.change_resolution(
        'mobile_actual_view_screenshot_video.png')
    ...
    try:
        ...
        for view_type in view_types:
            expected_screenshot_filename = f'{view_type}_view_screenshot_video.png'
            actual_screenshot_filename = f'{view_type}_actual_view_screenshot_video.png'
            # OPEN THE EXPECTED IMAGE AND ACTUAL IMAGE
    ...
    campaign_settings_page.wait_for_visibility_of_element(
        CampaignSettingsLocator.preview_previous_title)
    assert campaign_data['landing_and_creatives']['creative'] in campaign_settings_page.get_element_text(
