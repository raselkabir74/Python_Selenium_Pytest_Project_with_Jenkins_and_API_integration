...
def test_regression_js_banner_preview_page(login_by_user_type):
    ...
    banner_creative_data['general_information'][
        'title'] = "Test JS Preview Banner_" + generic_modules.get_random_string(5)
    ...
    campaign_data['name_and_type'][
        'campaign_name'] = 'Automation JS Preview Banner'
    ...
    campaign_page.take_screenshot(
        'desktop_actual_view_screenshot_js_banner.png')
    ...
    time.sleep(4)
    campaign_page.take_screenshot(
        'mobile_actual_view_screenshot_js_banner.png')
    campaign_page.change_resolution(
        'mobile_actual_view_screenshot_js_banner.png')
    # IMAGES VERIFICATION
    ...
    try:
        ...
        for view_type in view_types:
            expected_screenshot_filename = f'{view_type}_view_screenshot_js_banner.png'
            actual_screenshot_filename = f'{view_type}_actual_view_screenshot_js_banner.png'
